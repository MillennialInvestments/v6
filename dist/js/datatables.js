 ...
 *   https://datatables.net/download/#bs4/dt-1.10.20/b-1.6.1/b-html5-1.6.1/r-2.2.3/rg-1.1.1/rr-1.2.6/sp-1.0.1
 *
 * Included libraries:
 *   DataTables 1.10.20, Buttons 1.6.1, HTML5 export 1.6.1, Responsive 2.2.3, RowGroup 1.1.1, RowReorder 1.2.6, SearchPanes 1.0.1
 */
...
(function( $, window, document, undefined ) {
	...
	DataTable.ext = _ext = {
		 ...
		 *  @type string
		 */
		build:"bs4/dt-1.10.20/b-1.6.1/b-html5-1.6.1/r-2.2.3/rg-1.1.1/rr-1.2.6/sp-1.0.1",
